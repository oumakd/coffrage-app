...
# Entrées utilisateur
entree = st.text_area("Entrez les hauteurs des piles (en mètres), séparées par des espaces :", value="6 6 8 8 8 6 6")
D = st.number_input("Entrez le délai maximal D (en jours) : ", min_value=0.0, value=190.0)
V = st.number_input("Entrez la vitesse de bétonnage V (en m/jour) : ", min_value=0.0, value=4.0)
Tm = st.number_input("Entrez le temps de montage et démontage (en jour) : ", min_value=0.0, value=6.0)
